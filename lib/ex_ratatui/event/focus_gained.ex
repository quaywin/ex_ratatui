defmodule ExRatatui.Event.FocusGained do
  ...
  Focus reporting is opt-in: `ExRatatui.run(fun, focus_events: true)`
  enables crossterm's `EnableFocusChange`. Terminals that don't support
  focus reporting silently ignore the request and no Focus events
  arrive — apps don't need a conditional path.
