...
| [`widget_showcase.exs`](https://github.com/mcass19/ex_ratatui/blob/main/examples/widgets/widget_showcase.exs) | `mix run examples/widgets/widget_showcase.exs` | Tabbed tour of progress bars, checkboxes, text input, scrollable logs, BarChart, Sparkline, Calendar, Canvas, Chart, and more. A reference for what each widget looks like. |
